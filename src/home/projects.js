...
export default function Projects()
{
    ...
    return(
        <main className="h-screen w-screen flex flex-col bg-slate-800 justify-center px-5 items-center" id="projects">
            <h1 className="mb-5 mt-5 text-white font-bold w-screen text-4xl text-center pb-5">Explore My Previous Works</h1>
            <div className="flex flex-row bg-white p-5 w-fit rounded-lg gap-5" >

...
export default function Projects()
{
    ...
    return(
        <main className="h-screen w-screen flex flex-col bg-slate-800 justify-center" id="projects">
            <h1 className="mb-5 mt-5 text-white font-bold w-screen text-4xl text-center pb-5">Explore My Previous Works</h1>
            <div className="flex flex-row bg-white sm:p-5 p-1 justify-evenly ml-5 mr-5 rounded-lg" >
                {projects.map((project=>
                <div
                    className="bg-slate-600 rounded-lg flex flex-col sm:h-60 h-24 relative items-center hover:shadow-inner hover:opacity-95 hover:cursor-pointer hover:border-4 lg:w-40 md:w-28 "

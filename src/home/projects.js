    ...
    return(
        <main className="h-screen w-screen flex flex-col bg-darkBlue justify-center items-center" id="projects">
            ...
            <div className="flex flex-row bg-bluegray p-5 w-fit rounded-lg gap-5" >
                ...
                <div
                    className="bg-darkBlue rounded-lg flex flex-col sm:h-60 h-24 relative items-center hover:shadow-inner hover:opacity-80 hover:cursor-pointer hover:border-4 border-bluegray lg:w-40 md:w-28 "

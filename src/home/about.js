...
{ 
    ...
    return(
        <main className="flex flex-col justify-top bg-bluegray h-screen w-screen lg:pt-20 pt-10"id="about">
          <div className="lg:px-24 px-5">
            <h1 className=" text-silver lg:text-5xl text-2xl text-left w-full mb-5 top-0">Get to Know Me</h1>
            <p className="text-silver lg:mb-10 mb-5">
